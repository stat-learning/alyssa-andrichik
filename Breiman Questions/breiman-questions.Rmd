...
The Rashomon Effect is when there is a multitude of different equations of f(x) in a class of functions giving about the same minimum error rate, meaning many different models seem like they all would work just as well at predicting. 
We haven't worked on number 5 yet because we haven't gone over it in class.
